...
namespace backend.Controllers
{
    ...
    public class UsersController : ControllerBase
    {
        ...
        public async Task<IActionResult> UpdateUserStatusAsync([FromBody] UpdateUserStatusDto userStatusDto)
        {
            var result = await _userRepository.UpdateUserStatusAsync(userStatusDto.Id, userStatusDto.Status);
            return result ? Ok() : BadRequest();
        }
