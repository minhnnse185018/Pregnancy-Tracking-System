    ...
    public partial class init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "At 12 weeks, the average fetal weight is between 14 and 20 grams.", "Fetal Development", new DateTime(2025, 3, 15, 19, 10, 40, 807, DateTimeKind.Local).AddTicks(5444), 1, "What is the normal fetal weight at 12 weeks?", new DateTime(2025, 3, 15, 19, 10, 40, 807, DateTimeKind.Local).AddTicks(5442) },
                    { 2, "During the first 28 weeks, visits are typically scheduled every 4 weeks. Between 28-36 weeks, every 2-3 weeks. After 36 weeks, weekly visits are recommended.", "Prenatal Care", new DateTime(2025, 3, 15, 19, 10, 40, 807, DateTimeKind.Local).AddTicks(5446), 2, "How often should I have prenatal check-ups?", new DateTime(2025, 3, 15, 19, 10, 40, 807, DateTimeKind.Local).AddTicks(5445) }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2025, 3, 15, 19, 10, 40, 807, DateTimeKind.Local).AddTicks(5197), null, "1@gmail.com", null, null, null, "111111", null, null, null, "active", "1" },
                    { 2, new DateTime(2025, 3, 15, 19, 10, 40, 807, DateTimeKind.Local).AddTicks(5200), null, "2@gmail.com", null, null, null, "222222", null, null, null, "active", "5" }
                });

            migrationBuilder.InsertData(
                table: "Posts",
                columns: new[] { "Id", "Content", "CreatedAt", "Image", "Status", "Title", "UpdatedAt", "UserId" },
                values: new object[] { 1, "I'm excited to share my journey through the first trimester...", new DateTime(2025, 3, 15, 19, 10, 40, 807, DateTimeKind.Local).AddTicks(5472), null, "published", "My First Pregnancy Experience", new DateTime(2025, 3, 15, 19, 10, 40, 807, DateTimeKind.Local).AddTicks(5471), 1 });

            migrationBuilder.InsertData(
                table: "PregnancyProfiles",
                columns: new[] { "Id", "ConceptionDate", "CreatedAt", "DueDate", "UserId" },
                values: new object[] { 1, new DateTime(2024, 12, 15, 19, 10, 40, 807, DateTimeKind.Local).AddTicks(5397), new DateTime(2025, 3, 15, 19, 10, 40, 807, DateTimeKind.Local).AddTicks(5401), new DateTime(2025, 9, 11, 19, 10, 40, 807, DateTimeKind.Local).AddTicks(5401), 1 });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Thank you for sharing your experience! It's very helpful.", new DateTime(2025, 3, 15, 19, 10, 40, 807, DateTimeKind.Local).AddTicks(5491), 1, 2 },
                    { 2, "I'm glad you found it helpful! Feel free to ask any questions.", new DateTime(2025, 3, 15, 20, 10, 40, 807, DateTimeKind.Local).AddTicks(5492), 1, 1 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2025, 3, 15, 19, 10, 40, 807, DateTimeKind.Local).AddTicks(5423), 25.5m, null, 1, 12, 500.00m },
                    { 2, new DateTime(2025, 3, 15, 19, 10, 40, 807, DateTimeKind.Local).AddTicks(5425), 28.5m, null, 1, 16, 650.00m }
                });
